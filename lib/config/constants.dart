...
class GameColors {
  ...
  static const Color primary = Color(0xFFF28B82);
  static const Color secondary = Color(0xFFFBBC04);
  static const Color accent = Color(0xFF34A853);
  static const Color success = Color(0xFF4285F4);
  static const Color warning = Color(0xFFFF6D01);
